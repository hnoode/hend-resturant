        ...
        <div class="container" style="padding: 10px;">
            <nav id="cuisine" style="padding: 15px;">
                ...
                <div class="col-sm-6 gap-col-top">
                    <div>
                        <img src="pasta.jpg" style="padding:20px;" alt="Food">
                    </div>
                </div>
                <br><br>
                <form method="post" action="test_update.php">
                    ...
                    $connect = mysqli_connect("localhost", "root", "") or die ("couldn't connect");
                    mysqli_select_db($connect, "hend resturant") or die ("couldn't find db");
                    $query2 = "SELECT * FROM menu WHERE `mail ID` =1";
                ...
                <div class="col-sm-6 gap-col-top">
                    <div>
                        <img src="pizza.jpg" style="padding:20px;" alt="Food">
                    </div>
                </div>
                <br><br><br>
                <form method="post" action="test_update.php">
                    ...
                    $connect = mysqli_connect("localhost", "root", "") or die ("couldn't connect");
                    mysqli_select_db($connect, "hend resturant") or die ("couldn't find db");
                    $query2 = "SELECT * FROM menu WHERE `mail ID` =2";
                    mysqli_error($connect);
                    $result2 = mysqli_query($connect, $query2);
                    while ($row = mysqli_fetch_assoc($result2)) {
                        $id = $row['mail ID'];
                ...
                <form method="post" action="test_update.php">
                    <div class="col-sm-6 gap-col-top">
                        <div>
                            <img src="cani.jpg" style="padding:20px;" alt="Food">
                        </div>
                    </div>
                    <br><br><br>
                    <?php
                    $connect = mysqli_connect("localhost", "root", "") or die ("couldn't connect");
                    mysqli_select_db($connect, "hend resturant") or die ("couldn't find db");
                    $query2 = "SELECT * FROM menu WHERE `mail ID` =3";
                    mysqli_error($connect);
                    $result2 = mysqli_query($connect, $query2);
                    while ($row = mysqli_fetch_assoc($result2)) {
                        $id = $row['mail ID'];
