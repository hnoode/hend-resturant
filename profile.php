    ...
    <section class='sub-content' style="padding: 100px;">
        <div class="container" style="padding: 10px;">
            <nav id="cuisine_shortcuts" style="padding: 15px;">
                ...
                <?php
                echo "<div id='myDIV' ";
                echo "<h1><strong> This is your information</strong> </h1> <br>";

                echo "<table ><br> 
   
    <th> &nbsp Email</th>
      <th> &nbsp Name</th>
      <th>  &nbsp  &nbsp password</th>
      </tr>";


                $res = mysqli_query($connect, "SELECT * FROM customers where email='$email'");
